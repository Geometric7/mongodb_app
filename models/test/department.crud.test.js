...
describe('Department', () => {
  ...
  describe('Reading data', () => {
    ...
    it('TEST_10 - should return all the data with "find" method', async () => {
      const departments = await Department.find();
      const expectedLength = 2;
      expect(departments.length).to.be.equal(expectedLength);
    });

    it('TEST_11 - should return a proper document by "name" with "findOne" method', async () => {
  ...
  describe('Creating data', () => {
    it('TEST_12 - should insert new document with "insertOne" method', async () => {
  ...
  describe('Updating data', () => {
    ...
    it('TEST_13 - should properly update one document with "updateOne" method', async () => {
    ...
    it('TEST_14 - should properly update one document with "save" method', async () => {
      const department = await Department.findOne({ name: 'Department #1' });
    ...
    it('TEST_15 - should properly update multiple document with "updateMany" method', async () => {
  ...
  describe('Removing data', () => {
    ...
    it('TEST_16 - should properly remove one document with "deleteOne" method', async () => {
    ...
    it('TEST_17 - should properly remove one document with "remove" method', async () => {
      const department = await Department.findOne({ name: 'Department #1' });
    ...
    it('TEST_18 - should properly remove multiple document with "deleteMany" method', async () => {
      await Department.deleteMany({});
      const departments = await Department.find();
