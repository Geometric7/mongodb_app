...
describe('Employee', () => {
  ...
  describe('Reading data', () => {
    ...
    it('TEST_19 - should return all the data with "find" method', async () => {
      const employees = await Employee.find();
      const expectedLength = 2;
      expect(employees.length).to.be.equal(expectedLength);
    });

    it('TEST_20 - should return proper document by various params with "findOne" method', async () => {
  ...
  describe('Creating data', () => {
    it('TEST_21 - should insert new document with "insertOne" method', async () => {
  ...
  describe('Updating data', () => {
    ...
    it('TEST_22 - should properly update one document with "updateOne" method', async () => {
    ...
    it('TEST_23 - should properly update one document with "save" method', async () => {
      const employee = await Employee.findOne({
        firstName: 'first_name_002',
        lastName: 'last_name_002',
        department: 'department_002',
    ...
    it('TEST_24 - should properly update multiple documents with "updateMany" method', async () => {
  ...
  describe('Removing data', () => {
    ...
    it('TEST_25 - should properly remove one document with deleteOne method', async () => {
    ...
    it('TEST_26 - should properly remove one document with remove method', async () => {
      const employee = await Employee.findOne({
        firstName: 'first_name_001',
        lastName: 'last_name_001',
        department: 'department_001',
    ...
    it('TEST_27 - should properly remove multiple documents with "deleteMany" method', async () => {
      await Employee.deleteMany({});
      const employees = await Employee.find();
