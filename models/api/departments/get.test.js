...
describe('GET /api/departments', () => {
  ...
  it('TEST_28 - / should return all departments', async () => {
  ...
  it('TEST_29 - /:id should return one department by :id', async () => {
  ...
  it('TEST_30 - /random should return one random department', async () => {
